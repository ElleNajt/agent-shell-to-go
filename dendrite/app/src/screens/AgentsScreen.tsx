...
interface AgentsScreenProps {
    ...
    graphViewport: ViewportState;
    onGraphViewportChange: (viewport: ViewportState) => void;
}
            ...
            if (stored) {
                ...
                if (current) {
                    ...
                    await AsyncStorage.setItem(
                        ...
                        JSON.stringify([defaultMachine, ...list]),
                    );
                }
            } else {
        ...
        <View style={styles.header}>
            ...
            >
                <Text style={styles.title}>
                    {currentMachine?.name || "Agent Graph"}
                </Text>
                        ...
                        <ScrollView style={styles.machinesList}>
                            {machines.map((machine, i) => (
                                <TouchableOpacity
                                    ...
                                    style={[
                                        styles.machineItem,
                                        currentMachine?.url === machine.url &&
                                            styles.machineItemActive,
                                    ]}
        ...
        <View style={styles.container}>
            ...
            {viewMode === "graph" ? (
                <GraphView
                    ...
                    hasUnread={(sessionId, lastActivity, lastMessageRole) =>
                        selectedAgent?.session_id !== sessionId &&
                        hasUnread(sessionId, lastActivity, lastMessageRole)
                    }
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <AgentNode
                            agent={item}
                            selected={
                                selectedAgent?.session_id === item.session_id
                            }
