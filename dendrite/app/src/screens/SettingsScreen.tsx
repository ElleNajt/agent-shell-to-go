...
export function SettingsScreen({ onConfigured }: SettingsScreenProps) {
    ...
    const testConnection = async () => {
        ...
        if (!token.trim()) {
            Alert.alert("Error", "Please enter API token");
            return;
        }
        ...
        <View style={styles.container}>
            ...
            <View style={styles.form}>
                ...
                <TextInput
                    ...
                    placeholder="Paste token from ~/.dendrite/token"
                    placeholderTextColor="#666666"
                    autoCapitalize="none"
                    autoCorrect={false}
                    secureTextEntry
            ...
            <Text style={styles.hint}>
                The backend should be running on your Tailscale network. Make
                sure Tailscale is connected on this device.
            </Text>
        </View>
    );
}
